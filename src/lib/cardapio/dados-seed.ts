...
export const MAPA_FORNECEDORES_SEED: Record<string, string> = {
  ...
  'tilapia': 'Mar Fish',
  'merluza': 'Mar Fish',
  'file de peixe': 'Mar Fish',
  'sardinha': 'Mar Fish',
  'panga': 'Mar Fish',
  // ── Complemento do pente-fino: cobre todo item que aparece nos cardápios ──
  // Bovinos/base (cortes herdam via ingrediente base) — JAMPAC
  'carne': 'JAMPAC Alimentos',
  'carne em cubos': 'JAMPAC Alimentos',
  'carne seca': 'JAMPAC Alimentos',
  'fraldinha': 'JAMPAC Alimentos',
  'tiras de carne': 'JAMPAC Alimentos',
  'almondegas': 'JAMPAC Alimentos',
  // Aves — Vita Frango
  'frango': 'Vita Frango',
  'frango em cubos': 'Vita Frango',
  // Suínos — WG
  'pernil de porco fatiado': 'WG',
  // Hortifrúti — FLD
  'couve': 'FLD',
  'manga': 'FLD',
  'mamao': 'FLD',
  ...
  'alho': 'FLD',
  'fritas': 'FLD',
  // Secos / mercearia — Malte
  'grao de bico': 'Malte',
  'ervilha': 'Malte',
  'lentilha': 'Malte',
  'feijao vermelho': 'Malte',
  'macarrao': 'Malte',
  'massa de lasanha': 'Malte',
  'fuba': 'Malte',
  'flocao de milho': 'Malte',
  'amido de milho': 'Malte',
  'canjica de milho': 'Malte',
  'trigo para quibe': 'Malte',
  'farinha de mandioca': 'Malte',
  'farinha de rosca': 'Malte',
  'proteina de soja': 'Malte',
  'polenta': 'Malte',
  // Condimentos, molhos, laticínios, doces e sobremesas prontas — Biofood
  'maionese': 'Biofood',
  'molho de tomate': 'Biofood',
  'molho madeira': 'Biofood',
  'molho barbecue': 'Biofood',
  'barbecue': 'Biofood',
  'mostarda': 'Biofood',
  'creme culinario': 'Biofood',
  'creme de leite': 'Biofood',
  'leite condensado': 'Biofood',
  'milho (lata)': 'Biofood',
  'leite de coco': 'Biofood',
  'coco ralado': 'Biofood',
  'chocolate em po': 'Biofood',
  'uva passa': 'Biofood',
  'pacoca': 'Biofood',
  'amendoim torrado': 'Biofood',
  'sagu': 'Biofood',
  'canela em po': 'Biofood',
  'polpa de morango': 'Biofood',
  'bolacha maisena': 'Biofood',
  'palmito': 'Biofood',
  'batata palha': 'Biofood',
  'pure de batata': 'Biofood',
  'caldo de cozimento': 'Jonaldo',
  'mousse de chocolate': 'Biofood',
  'mousse de maracuja': 'Biofood',
  'mousse de morango': 'Biofood',
  'pudim': 'Biofood',
  'pudim de coco': 'Biofood',
  'flan de baunilha': 'Biofood',
  'suco de maracuja': 'Biofood',
  'suco de morango': 'Biofood',
  'suco de uva': 'Biofood',
};
...
export const PRECOS_COTACAO_SEED: Record<string, number> = {
  ...
  'canela em po': 44.00,
  // ── Pente-fino: preços de referência p/ zerar itens sem preço nos cardápios ──
  'amendoim torrado': 16.00,
  'cheiro verde': 15.00,
  'cogumelo': 26.00,
  'flocao de milho': 6.50,
  'fraldinha': 39.90,
  'hortela': 15.00,
  'lentilha': 11.50,
  'mandioquinha': 8.90,
  ...
  'palmito': 34.00,
  'pacoca': 18.00,
  'proteina de soja': 12.00,
  'sagu': 10.50,
  'sardinha': 14.00,
  'suco de uva': 12.00,
  'tilapia': 18.90,
  'trigo para quibe': 9.50,
};
